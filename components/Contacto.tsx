      ...
      >
        ...
        >
          <div>
            ...
            >
              ¿Enfrenta un desafío legal en materia administrativa, previsional
              o notarial? Contáctenos y uno de nuestros especialistas se
              ...
              {[
                {
                  icon: IconMail,
                  l: "Email",
                  v: "gracielaruoccoyasociados@gmail.com",
                },
                { icon: IconPhone, l: "Teléfono", v: "+598 2902 44 72" },
                {
                  icon: IconPin,
                  l: "Ubicación",
                  v: "Pza. Independencia 838/402, Montevideo",
                },
                {
                  icon: IconClock,
                  l: "Horario",
                  v: "Lun a Vie · 11:00 – 17:00",
                },
              ].map((c, i) => {
                const Ic = c.icon;
                return (
          ...
          >
            {sent ? (
              <div style={{ padding: "60px 20px", textAlign: "center" }}>
                ...
                >
                  Hemos recibido su consulta. Uno de nuestros especialistas se
                  comunicará con usted dentro de las próximas 24 horas hábiles.
                </p>
                <button
                  type="button"
                  onClick={() => {
              ...
              <>
                ...
                >
                  ...
                  <div>
                    ...
                    <input
                      {...field("empresa")}
                      placeholder="Su empresa (si aplica)"
                    />
                  </div>
                  <div>
                ...
                >
                  ...
                  personales. Respuesta garantizada dentro de 24 h hábiles.
                </p>
              </>
            )}
          </form>
