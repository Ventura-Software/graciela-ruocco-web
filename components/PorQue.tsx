...
const REASONS: Reason[] = [
  {
    ...
    desc: "Enfocados exclusivamente en Derecho Administrativo, Previsión Social, Recursos Humanos y Servicios de Escribanía. No somos generalistas: somos especialistas en las materias que importan.",
  },
  {
    n: "02",
  ...
  >
    ...
    >
      <div style={{ textAlign: "center", marginBottom: 48 }}>
        ...
        >
          Más de dos décadas acompañando a nuestros clientes, basados en
          resultados concretos y transparencia total.
        </p>
      </div>
